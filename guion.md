...
Revisaremos brevemente tres de las más trascendentes, ya aplicadas a los juegos de interfaz
...
Siguiendo la tesis de Frasca, los modelos de simulación en el videojuego filtran ideología, provocada durante el proceso de modelado del sistema de referencia.

Esta manipulación se puede ver en 4 niveles:
- Representación de objetos
- En sus reglas de comportamiento
- En las condiciones de victoria
- Y en la capacidad que ofrecen de modificar sus propias reglas (metareglas)

Siendo los VJIU una doble simulación, esta manipulación puede ocurrir en ambos contextos
...
Que el usuario se enfoque en la tarea y no en la interfaz decía Don Norman, padre del diseño de experiencia de usuario
...
◦ Como externa, nos referimos a las interfaces de usuario desplegadas en objetos (ordenadores) colocados en un espacio tridimensional dentro del juego. 
...
Y fue presentada en la muestra PAM 2019 de esta universidad
